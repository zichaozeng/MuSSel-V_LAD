...
class VPAir(CustomDataset):
    ...
    """
    def __init__(self,args,datasets_folder,dataset_name="vpair",split="train",use_ang_positives=False,dist_thresh = 10,ang_thresh=20,use_mixVPR=False,use_SAM=False):
        super().__init__()
